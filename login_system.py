...
def main_account_screen():
    ...
    main_screen.configure(main_screen)
    main_screen.geometry("750x500+0+0") # set the configuration of GUI window
    main_screen.title("Account Login") # set the title of GUI window

# create a Form label
Label(text="Choose Login Or Register", bg="cadetblue", width="300", height="2", font=("Calibri", 13)).pack()
Label(text="").pack()
